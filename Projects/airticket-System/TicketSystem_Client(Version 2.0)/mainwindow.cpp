...
MainWindow::MainWindow(QWidget *parent)
    ...
    QPalette palette;
    QPixmap pixmap(":/source/images/9.jpg");
...
//    form.addRow(new QLabel("<h1>飞机售票模拟系统客户端</h1>"));
//    form.addRow(new QLabel("<center>版本 V 1.0</center>"));
//    //form.addRow(new QLabel("本程序仅用于测试，请勿用于商业目的"));
//    form.addRow(new QLabel("作者信息: 崔凤朝 梁世豪 罗晓萌"));
//    form.addRow(new QLabel("日  期: 2020年06月18日"));
//    QDialogButtonBox buttonBox(QDialogButtonBox::Ok, &dialog);
//    form.addRow(&buttonBox);
//    QObject::connect(&buttonBox, SIGNAL(accepted()), &dialog, SLOT(accept()));
//    if (dialog.exec() == QDialog::Accepted) {
